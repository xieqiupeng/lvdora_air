...
public class StudyGraphView1 extends View {
	...
	public static final int SHOW_NUM=34;
	...
	public StudyGraphView1(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext=context;
		initParam();
	}
	...
	private void initParam(){
		...
		coordinateMarginRight= 0f;//spacingOfX;
...
//			 canvas.drawText(energy.getAqi() + "",textPoint.x - 10,textPoint.y - 20, paint);// 这里注意，坐标(180,180)是文本的左下点坐标
		...
		for (int i = 0; i < points.size(); i++) {
			...
			paint.setStrokeWidth(15.0f);//扩大点的宽度
			 if ( energy.getAqi() < 50) {
